...
const matchesList = [
  ...
  },
  {
    ...
    bio: 'I hate trains and love coffee. Live Laugh Love and I need me a man that loves watching tv as much as I do. I hope he does not mind the monthly pedicures! lol',
    age: 25,
    location: 'New Orleans',
    gender: 'Female',
      ...
      <Stack direction="column" spacing={1} sx={{ height: '500px', width: '100%', overflow: 'auto' }}>
        {matches.map((match) => (
          <Stack style={style} key={match.username} direction="row" sx={{ height: '100%', width: '100%' }} spacing={1}>
            <Card key={match.username} sx={{ height: '100%', width: '100%', }}>
